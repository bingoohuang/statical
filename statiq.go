...
// a directory and its contents as zip data for statiq file system.
package main
...
// be read by the statiq/fs HTTP file system.
func generateSource(srcPath string) (file *os.File, err error) {
	...
	var qb bytes.Buffer
	_, _ = fmt.Fprintf(&qb, `// Code generated by statiq. DO NOT EDIT.
%s%s
package %s
