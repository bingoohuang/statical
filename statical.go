...
// a directory and its contents as zip data for statical file system.
package main
...
var (
	...
	flagPkg        = flag.String("p", "statical", "Name of the generated package")
	flagPkgCmt     = flag.String("c", "Package statical contains static assets.", "The package comment. An empty value disables this comment.\n")
)
...
func rename(src, dest string) error {
	...
	defer func() {
		_ = rc.Close()
		_ = os.Remove(src) // ignore the error, source is in tmp.
	}()
...
// be read by the statical/fs HTTP file system.
func generateSource(srcPath string) (file *os.File, err error) {
	...
	var qb bytes.Buffer
	_, _ = fmt.Fprintf(&qb, `// Code generated by statical. DO NOT EDIT.
%s%s
package %s
